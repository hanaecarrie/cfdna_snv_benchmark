...
# It needs to be in the cfdna_snv_benchmark/callers/ABEMUS/ subfolder directly
...
if [ $# == 0 ]; then
    ...
    echo "$ bash $0 config_abemus_mixtures_chr1_CRC-986_100215-CW-T_CRC-986_300316-CW-T.yml"
    exit 1
fi
