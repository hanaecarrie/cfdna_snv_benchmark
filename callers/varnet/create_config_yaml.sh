...
# It needs to be in the cfdna_snv_benchmark/callers/varnet/ subfolder directly
...
if [ $# == 0 ]; then
    ...
    echo "$ bash $0 config_varnet_mixtures_chr1_CRC-986_100215-CW-T_CRC-986_300316-CW-T.yml"
    exit 1
fi
...
# Move to the cfdna_snv_benchmark/mixtures/varnet/config subfolder
cd config
