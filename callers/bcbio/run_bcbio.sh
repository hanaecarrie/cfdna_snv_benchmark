...
cp /mnt/projects/carriehc/cfDNA/cfdna_snv/cfdna_snv_benchmark/callers/bcbio/config/bcbio_config_chr22_mix_spik.tsv /mnt/projects/skanderupamj/wgs/data/cfdna.crc/benchmark/patients_wgs.tsv
