...
#SBATCH -p normal
#SBATCH -J 2_986_cfsnv
#SBATCH -t 3-00:00:00
#SBATCH -N 1
#SBATCH --mem 64000
#SBATCH --output=/rfs-storageservice/GIS/Projects/LOCCG/carriehc/cfsnv_outdir/logs/z.2_986_cfsnv.o
#SBATCH --error=/rfs-storageservice/GIS/Projects/LOCCG/carriehc/cfsnv_outdir/logs/z.2_986_cfsnv.e
