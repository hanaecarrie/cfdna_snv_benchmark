...
export outputdir=$outputfolder/mixtures_chr${chr}_${samplename_tumor}/mixture_chr${chr}_${samplename_tumor}_${dilutionfactor_tumor}_${samplename_healthy}_${dilutionfactor_healthy}
...
export outputdirnew=$outputfolder/mixtures_${samplename_tumor}/mixture_chr${chr}_${samplename_tumor}_${dilutionfactor_tumor}_${samplename_healthy}_${dilutionfactor_healthy}
if [ ! -d $outputdirnew/logs ] ; then mkdir $outputdirnew/logs ; fi
qsub -pe OpenMP 4 -l mem_free=48G,h_rt=24:00:00 -o $outputdirnew/logs/ -e $outputdirnew/logs/ /mnt/projects/carriehc/cfDNA/cfdna_snv/cfdna_snv_benchmark/mixtures/create_mixture_dilution_chr.sh -c $config_file -d $dilutionfactor
