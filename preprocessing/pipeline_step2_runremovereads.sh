...
cat  $path_data/data/prepare_pooled_healthy/readfile_${patient}*_gnomad_*.txt  $path_data/data/prepare_pooled_healthy/readfile_${patient}*_dbsnp.txt >>  $path_data/data/prepare_pooled_healthy/readfile_${patient}_total.txt
fi
